...
RUN --mount=type=cache,target=/go/pkg/mod \
    ...
    -ldflags "-X 'transitflow/internal/buildinfo.CommitHash=${GIT_COMMIT}' \
    ...
    -o transitflow ./cmd/api

# Runtime stage
FROM alpine:3.24

LABEL org.opencontainers.image.source="https://github.com/Smriti404/TransitFlow"
